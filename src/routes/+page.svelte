...
Note: attribution is to Rafa, who did a wonderful job on the design and I've learned so much from the CSS which
is remarkably extensive. So what did I do? I morphed the code to Svelte as an experiment on how to re-write code the Svelte way.
I achieved a modest reduction in the code, leveraged Svelte's reactivity and declarative style and could probably do more (Rafa likes div's 8)
Here is the codepen link: https://codepen.io/RAFA3L/pen/PoVYoPN
...
<script>
	...
	// @ts-ignore
	let divElement; //main div element
	let date = new Date();

	$: hour = handleHours(date);
	$: min = padWithSpace(date.getMinutes().toString().padStart(2, '0'));
	$: month = padWithSpace((date.getMonth() + 1).toString().padStart(2, '0'));
	...
	function handleHours(date) {
		...
		return padWithSpace(tempHours.toString().padStart(2, '0'));
	}

	function handleClick() {
		// @ts-ignore
		divElement.classList.toggle('off'); // toggle 'off' class, lights on or off
	}

	// @ts-ignore
	function padWithSpace(inputString) {
		return inputString.startsWith('0') ? ' ' + inputString.slice(1) : inputString;
	}
</script>
...
<div class="clock off" bind:this={divElement}>
	<div class="shadow" />

	<div class="base-container"><div class="base"><div /></div></div>
	<div class="small-outer-pipe">
		<div class="small-inner-pipe" />
	</div>
	<div class="outer-pipe">
		<div class="inner-pipe" />
	</div>
	...
	<div class="display">
		<div class="row">
			<div class="col">
				<div>8</div>
				<div id="char01">{hour[0]}</div>
				<div id="char02">{hour[0]}</div>
			</div>
			<div class="col">
				<div>8</div>
				<div id="char11">{hour[1]}</div>
				<div id="char12">{hour[1]}</div>
			</div>
		</div>
		<div class="row">
			<div class="col">
				<div>8</div>
				<div id="char21">{min[0]}</div>
				<div id="char22">{min[0]}</div>
			</div>
			<div class="col">
				<div>8</div>
				<div id="char31">{min[1]}</div>
				<div id="char32">{min[1]}</div>
			</div>
		</div>
		...
		<div class="small-row">
			<div class="row">
				<div class="col">
					<div>8</div>
					<div id="char41">{dayOrNight[0]}</div>
					<div id="char42">{dayOrNight[0]}</div>
				</div>
				<div class="col">
					<div>8</div>
					<div id="char51">{dayOrNight[1]}</div>
					<div id="char52">{dayOrNight[1]}</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col">
				<div>8</div>
				<div id="char61">{month[0]}</div>
				<div id="char62">{month[0]}</div>
			</div>
			<div class="col">
				<div>8</div>
				<div id="char71">{month[1]}</div>
				<div id="char72">{month[1]}</div>
			</div>
		</div>
		<div class="row">
			<div class="col">
				<div>8</div>
				<div id="char81">{day[0]}</div>
				<div id="char82">{day[0]}</div>
			</div>
			<div class="col">
				<div>8</div>
				<div id="char91">{day[1]}</div>
				<div id="char92">{day[1]}</div>
			</div>
		</div>
		<div class="row">
			<div class="col">
				<div>8</div>
				<div id="char101">{year[0]}</div>
				<div id="char102">{year[0]}</div>
			</div>
			<div class="col">
				<div>8</div>
				<div id="char111">{year[1]}</div>
				<div id="char112">{year[1]}</div>
			</div>
		</div>
	</div>
	...
	<div class="button" on:click={handleClick} on:keydown={handleClick} role="button" tabindex="0">
		<div />
	</div>
</div>
...
<style>
	* {
	...
	/*
	 * svelte styles are scoped by default. You have to explicitly tell svelte that you want to apply a style globally.
	 */
	:global(html, body) {
		height: 100%;
		overflow: hidden;
	...
	.shadow {
		...
		height: 0em;
		translate: 0 45em;
		box-shadow: 0 0 3em 2em #040909, 0 0 8em 3em var(--_o3), 0 0 10em 4em var(--_o2),
	...
	.shadow::before {
		...
		height: 20em;
		width: 0;
		box-shadow: 0 0 8em 4em var(--_y1), 0 0 8em 6em var(--_y2), 0 0 8em 8em var(--_o1),
			0 0 8em 10em var(--_o2), 0 0 8em 12em var(--_o3);
	}
	.shadow::after {
		content: '';
		display: block;
	...
	.clock.off .shadow {
		box-shadow: 0 0 4em 3em #040909, 0 0 8em 3em var(--_o3), 0 0 10em 4em var(--_o2),
			0 0 10em 5em var(--_o1);
		opacity: 0;
	}
	.outer-pipe {
	...
	.inner-pipe {
		...
		scale: 0.84 0.91;
		border-radius: 15% / 7%;
		box-shadow: 0em 104em 16em 20em #040909, /* light on */ 0em 1.2em 1em 0.2em var(--m3),
			0em 1.2em 1em 0.5em var(--m2), 0em 1.2em 0.5em 1.2em var(--m1),
			0em 1.2em 1.2em 1.5em var(--m2), 0em 1.2em 2em 2em var(--m3),
			/* ---- */ 0em 90em 16em 20em #040909, /* nat light */ -1em 1em 2em 3.7em #040909,
			0.5em 0em 2em 3.7em #040909, 0em 0em 0em 4.6em var(--mw1), 0em 0em 0.5em 5em var(--mw1),
	...
	.pipe-accents .top-tube {
		...
		box-shadow: inset -0.2em 1.1em 1.4em -0.4em var(--mw1),
			/* light on */ inset 0em -1.2em 0.5em -1.1em var(--m1), inset 0em -1.2em 1em -0.8em var(--m2),
	...
	.pipe-accents .tube-holders div {
		...
		box-shadow: inset 0 0 0.1em 0.1em #ffffff5d,
			/* light on */ inset 0em -1.2em 0.5em -1.1em var(--m1), inset 0em -1.2em 1em -0.8em var(--m2),
			inset 0em -1.2em 1em -0.2em var(--m3) /* -------- */;
	}
	...
	.pipe-accents .topinset::before {
		...
		box-shadow: inset 0 0 0em 0.1em #040909, /* light on */ 0 0 0.5em 0.1em var(--_bloom),
			inset 0 0 1.3em 0.2em var(--_o3), inset 0 0 1.3em 0.4em var(--_o2),
			inset 0 0 1.3em 0.6em var(--_o1), inset 0 0 1.3em 2em var(--_y1) /* -------- */;
	...
	.pipe-accents .left div:nth-child(1)::before {
		...
		margin: auto;
		z-index: -1;
		box-shadow: inset 0em 0.3em 0.6em -0.4em var(--mw1),
	...
	.pipe-accents .left div:nth-child(2) {
		...
		box-shadow: inset -0.1em 0.4em 0.6em -0.2em var(--mw1),
			/* light on */ inset -1em 0em 0.8em -0.6em var(--m3), inset -1em 0em 0.9em 0em var(--m2),
	...
	.pipe-accents .left div:nth-child(2)::before {
		...
		z-index: -1;
		box-shadow: inset 0em 0.3em 0.6em -0.4em var(--mw1),
			/* light on */ inset 1em -0.1em 0.3em 0em var(--m3), inset 1em -0.1em 0.4em 0.2em var(--m2),
	...
	.pipe-accents .left div:nth-child(3)::before {
		...
		z-index: -1;
		box-shadow: inset 0em 0.3em 0.6em -0.4em var(--mw1),
			/* light on */ inset 1em 0.2em 0.3em -0.1em var(--m3), inset 1em 0.2em 0.4em 0em var(--m2),
	...
	.pipe-accents .right div:nth-child(3) {
		...
		border-bottom-left-radius: 40%;
		box-shadow: inset -0.1em 0.4em 0.6em -0.2em var(--mw1),
			/* light on */ inset 1em 0.3em 0.8em -0.5em var(--m3), inset 1em 0.3em 0.9em -0.3em var(--m2),
	...
	.pipe-accents .bottom-left {
		...
		box-shadow: inset -0.4em -0.1em 1em -0.4em var(--mw1),
			/* light on */ inset -2em 0em 1.8em -1.5em var(--m3), inset -2em 0em 1.9em -1.3em var(--m2),
	...
	.small-inner-pipe {
		...
		box-shadow: 0em -94em 20em 20em #040909, 0em 104em 20em 20em #040909,
			...
			0em 1em 0.5em 1.2em var(--m1), 0em 1em 1.2em 1.5em var(--m2), 0em 1em 2em 2em var(--m3),
			/* ---- */ /* nat light */ -0.2em 0.5em 0.8em -0.2em var(--mw1), 0em 90em 16em 20em #040909,
			-1em 1em 2em 2em #040909, 0.5em 0em 2em 2em #040909, 0em 0em 0em 4.6em var(--mw1),
			0em 0em 1.5em 5em var(--mw1), /* --------- */ 0em 0em 0em 20em #040909;
	}
	...
	.base-container .base div::before {
		...
		box-shadow: 0 2em 10em 0 #000, inset -0.4em 0em 0.8em 0em var(--mw1),
			...
			inset 0em 0em 1em 0em #040909, inset 0em 0em 2em 0em #040909, inset 0em 0em 3em 0em #040909,
	...
	.tube-base {
		...
		box-shadow: inset 0em -0.1em 1.2em -0.4em var(--mw1),
			/* light on */ inset 0em 3em 2.8em -2.5em var(--m3), inset 0em 3em 3.9em -2.3em var(--m2),
	...
	.tube-base::before {
		...
		border-radius: 50%;
		box-shadow: inset 0em -0.1em 1.2em -0.4em var(--mw1),
			/* light on */ inset 0em 0em 1.8em -0.5em var(--m3), inset 0em 0em 1.9em -0.3em var(--m2),
	...
	.tube-btm {
		...
		box-shadow: inset 0em 0em 1.2em -0.2em var(--mw1),
			/* light on */ inset 0em 0.3em 1.2em 0em var(--m1), inset 0em 0.3em 1.2em 0.3em var(--m2),
	...
	.tube-btm::before {
		...
		box-shadow: inset 0em -0.1em 0.7em -0.2em var(--mw1),
			/* light on */ inset 0em 0.1em 1em -0.7em var(--m1), inset 0em 0.1em 1em -0.3em var(--m2),
	...
	.button {
		...
		box-shadow: 0em -0.1em 0.2em 0em var(--_o1), 0em -0.1em 0.2em 0.1em var(--_o2),
			...
			/* light on */ inset 0em 0em 1em 0em var(--_o3), inset 0em 0em 1em 0.5em var(--_o2),
	...
	*:after {
	...
	.clock.off .pipe-accents .topinset::before {
		box-shadow: inset 0 0 0em 0.1em #040909,
	...
	.clock.off .small-inner-pipe {
		...
		box-shadow: 0em -94em 20em 20em #040909, 0em 104em 20em 20em #040909,
			...
			0em 1em 0.5em 1.2em rgba(0, 0, 0, 0), 0em 1em 1.2em 1.5em rgba(0, 0, 0, 0),
	...
	.clock.off .glass-tube {
		box-shadow: 
    /* light off */ 0em 0em 1em -0.2em rgba(0, 0, 0, 0),
			0em 0em 2em -0.4em rgba(0, 0, 0, 0), 0em 0em 3em -0.4em rgba(0, 0, 0, 0),
			inset 0em 0em 0.4em 0.2em rgba(0, 0, 0, 0), inset 0em 0em 0.6em 0.4em rgba(0, 0, 0, 0),
			inset 0em 0em 1em 0.7em rgba(0, 0, 0, 0), inset 0em 0em 3em 0em rgba(0, 0, 0, 0),
			inset 0em 0em 5em 1em rgba(0, 0, 0, 0), /* -------- */ inset -0.1em 0.1em 0.1em 0em var(--mw1),
	...
	.clock.off .button {
		...
		box-shadow: 0em -0.1em 0.2em 0em #040909, 0em -0.1em 0.2em 0.1em #040909,
			...
			/* light off */ inset 0em 0em 1em 0em var(--mw1), inset 0em 0em 1em 0.5em var(--mw1),
